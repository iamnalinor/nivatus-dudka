...
class DataBase:
    def loadAccount(self):
        ...
        if user_data:
            ...
            self.player.theme = user_data["theme"]
            self.player.banned = user_data["banned"]
            self.player.ban_reason = user_data['ban_reason']
    ...
    def createAccount(self):
        ...
        data = {
            ...
            "banned": self.player.banned,
            "ban_reason": self.player.ban_reason,
        }
        ...
        data = {
            ...
            "chat": {
                "1": {
                    ...
                    "PlayerRole": 2,
                    "Message": "Добро пожаловать в клуб! Введите /help для списка команд."
                }
            }
        }
